...
public class CartItem extends RecyclerView.Adapter<CartItem.ViewHolder> {
    ...
    public CartItem(Context con, ArrayList<addtocartlist> listitems, Datainterface_shoppinglist dtfshoppinglist) {
        this.con = con;
    ...
    @NonNull
    @Override
    public CartItem.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.shoppingcart,parent,false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull CartItem.ViewHolder holder, int position) {
        ...
        for(int i=0;i<addtocart.getbtn_size();i++){
            ...
            sub_item_delete_btn.setBackground(ContextCompat.getDrawable(con, R.drawable.ic_baseline_delete));
            ...
            if(dbh.get_ingredient_type(sub_item_name.getText().toString()).equals("tobuy")){
            ...
            else if(dbh.get_ingredient_type(sub_item_name.getText().toString()).equals("purchased")){
                Log.d("msgtag","ans is:"+sub_relative_item_lay.getParent()+" "+sub_item_name.getText().toString());
            ...
            sub_item_name.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (dbh.get_ingredient_type(sub_item_name.getText().toString()).equals("tobuy")) {
                        dbh.update("purchased", sub_item_name.getText().toString());
                        Log.d("msgtag", "value is:" + dbh.get_ingredient_type(sub_item_name.getText().toString()));
                        Log.d("msgtag","ans is:"+sub_relative_item_lay.getParent().toString());
                        Log.d("msgtag","ans is:"+sub_relative_item_lay.getParent()+" "+sub_item_name.getText().toString());
                        holder.whatsinmylist.removeView(sub_relative_item_lay);
                        holder.whatigot.addView(sub_relative_item_lay);
                        sub_item_name.setChecked(true);
                        sub_item_name.setPaintFlags(sub_item_name.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
                        Log.d("msgtag","ans1 is:"+sub_relative_item_lay.getParent().toString()+" "+sub_item_name.getText().toString());
                    }
                    else if (dbh.get_ingredient_type(sub_item_name.getText().toString()).equals("purchased")) {
                        dbh.update("tobuy", sub_item_name.getText().toString());
                        sub_item_name.setChecked(false);
                        Log.d("msgtag", "value is:" + dbh.get_ingredient_type(sub_item_name.getText().toString()));
                        Log.d("msgtag","ans is:"+sub_relative_item_lay.getParent()+" "+sub_item_name.getText().toString());
            ...
            sub_item_delete_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dbh.deleteingredient_cart(new addtocart(String.valueOf(sub_item_name.getText())));
                    dtf.setcount(dbh.get_count_ingredients_cart());
                    Log.d("msgtag","count from database is:"+dbh.get_count_ingredients_cart());
                }
            });
        }
